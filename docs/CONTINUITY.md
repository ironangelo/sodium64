...
### ACTIVE / RESUME HERE — E2d generic green; 16-line band-overrun semantic in flight
...
- **Decision rule:** semantic PASS means the 8-row target fails on a 16-line real section exactly by writing the second band beyond the strip, proving the section→band requirement dynamically. A fully intact suffix would falsify the address/section model; any other corruption or wrong main extent requires diagnosis before band-loop implementation.
