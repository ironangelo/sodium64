...
def prove_layout_source() -> None:
    ...
    section_capacity, event_capacity, headroom, framebuffer_guard = contract.prove_layout()
    if (section_capacity, event_capacity, headroom, framebuffer_guard) != (320, 24576, 8384, 13056):
        raise AssertionError("validated clean L0 layout no longer matches producer")
