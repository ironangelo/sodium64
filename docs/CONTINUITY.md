...
- Only after carrier geometry validates may the same frozen runtime be judged against the pixel oracle: compact active x=12..267 = 2,048× green `0x07C1`, compact borders 192× `0x55AA` with guards intact; corresponding main first band active x=12..267 = 2,048× red `0xF801` and zero green.
