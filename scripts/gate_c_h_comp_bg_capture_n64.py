#!/usr/bin/env python3
"""Capture raw/add/half-add Sodium64 framebuffers for Gate-C H-COMP BG test.
...
fresh non-blank displayed framebuffer plus selected emulator state for each
stable BG main/sub color-math phase.
"""
