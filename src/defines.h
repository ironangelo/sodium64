...
#define RDP_FILL (RDP_FRAME + 0x38)
#define RDP_WINDOW (RDP_FILL + 0x10)
#define RDP_TILE (RDP_WINDOW + 0x28)
#define RDP_TILE7 (RDP_TILE + 0x78)
...
#define CACHE_RETS (SHARED_JUMPS + 0x8)
#define CACHE_PTRS (CACHE_RETS + 0x14)
#define SCRN_OFSV (CACHE_PTRS + 0x8)
