...
- Exact-head runs dispatched: **E2b Carrier Section Proof `35663719699`** and **Build and Validate `35663719717`**, both queued at checkpoint. Pass criterion remains unchanged: record 0 `WH0=0, TS=2, TM=1, split=8`; record 1 `WH0=1, TS=2, TM=1, split=224` in a stable queue, with fresh guest frame, SP HALT and DP idle.
