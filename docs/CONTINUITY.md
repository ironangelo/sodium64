...
- Exact-head runs dispatched: **E2c Shared Membership Proof `35672322670`** and **Build and Validate `35672322672`**. Superseded push-triggered baseline-oracle runs from `0484ddbf...` are not evidence.
