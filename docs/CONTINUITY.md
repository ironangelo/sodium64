...
### ACTIVE / RESUME HERE — E2d bounded band-reuse validation in flight
...
- **Immediate action:** inspect exact-head semantic `35675427000`. Require `E2D_BAND_REUSE_VALIDATED`, split 16/224, compact exact, **both guards intact**, and main rows 8..23 = 4,096 red. If green, close E2d bounded-reuse architecture proof; if red, diagnose only subloop/rebase/target ownership before compositor work.
