...
### ACTIVE / RESUME HERE — E2c shared suppression baseline VALIDATED; one-instruction repair next
...
- **Immediate E2c action:** inspect exact-head semantic `35672322670`. Require `E2C_SHARED_MEMBERSHIP_VALIDATED`, carrier `TS=TM=1` at 8/224, compact active 2,048× red `0xF801` + 192× sentinel with both guards intact, and main active 2,048× red. If green, close E2c; if red, diagnose traversal/cache/priority before compositor work.
