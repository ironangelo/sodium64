...
- Exact-head runs dispatched: **E2b Carrier Section Proof `35664655322`** and **Build and Validate `35664655335`**. Carrier geometry is already independently validated on the parent and should remain unchanged; this run now serves as the first same-SHA pixel capture after the one-variable address repair.
