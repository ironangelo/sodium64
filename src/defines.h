...
// Lossless Gate-C CGRAM epoch history. These KSEG1 ranges occupy the audited
// fixed-arena gap below HCOMP raw Q1 and remain outside the linked ELF.
...
// Exact W1/W2 window results use up to three inclusive [lower,upper] spans
