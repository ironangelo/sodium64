...
- **Representation remains OPEN.** Candidate directions include metadata in otherwise-available target bits, compact bitplanes/packed sideband, or proof-local screen-specific Z ownership. The audit establishes semantic information content, **not** that RGBA5551 alpha is safe: Sodium64/RDP alpha-test/blending interactions must be audited/proven before reusing the alpha bit.
