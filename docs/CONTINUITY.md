...
- Superseded/cancelled runs from earlier branch heads are not evidence. Exact-head runs now dispatched from `ecd7a2ec...`: **E2b Carrier Section Proof `35658901047`** and **Build and Validate `35658901019`**, both pending at checkpoint.
