...
- Exact-head runs dispatched: **E2d Band Reuse Proof `35675427000`** and **Build and Validate `35675426895`**. Earlier push-triggered overrun-oracle semantic from `9594c788...` is superseded and not repair authority.
